...
\begin{figure}[H]
  \centering
  \includegraphics[width = 3in]{../assets/frankesfunction_plot.png}
  \caption{Shape of Franke's function which will be used as a interpolating goal \cite{FrankeRichard1979}.}
