...
\begin{figure}[H]
 \centering
    \includegraphics[width=0.8\textwidth]{../assets/terrain_OLS_CI.png} 
...
\subsubsection{Lasso regression}
\autoref{fig:lasso_regularization} depicts the computed regularization path MSE$(d,\log_{10}(\lambda))$ with 5-fold cross validation. The minimum MSE is found with \ensuremath{d=18} and \ensuremath{\lambda=2.22 \cdot 10^{-3}}. \autoref{fig:lasso-estimate} shows the result of performing Ridge regression with $d=18$ and $\lambda=2.22 \cdot 10^{-3}$ on the terrain dataset. We obtain MSE and R2-scores of 13.39 and 0.9929, respectively. 
